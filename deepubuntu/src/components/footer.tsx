...
const PRODUCT_LINKS = [
    { label: "DeepUbuntu AV", href: "#" },
    { label: "cowcow CLI", href: "#" },
    { label: "Custom solutions", href: "#" },
];

const RESEARCH_LINKS = [
    { label: "Publications", href: "#" },
    { label: "Opensource", href: "#" },
    { label: "Datasets", href: "#" },
];
...
const SOCIAL_LINKS = [
    { icon: Facebook, href: "#" },
    { icon: Twitter, href: "https://x.com/deepubuntu" },
    { icon: Linkedin, href: "https://linkedin.com/company/deepubuntu" },
    { icon: Github, href: "https://github.com/deepubuntu" },
];
                    ...
                    <AnimationContainer animation="fadeRight" delay={0.4}>
                        <div className="flex flex-col items-start justify-start md:max-w-[300px]">
                            ...
                            <p className="text-muted-foreground mt-4 text-sm">
                                Comprehensive autonomous vehicle datasets from challenging real-world conditions. Training the next generation of self-driving technology.
                            </p>
                            <div className="mt-4 text-sm text-muted-foreground">
                                <p>support@deepubuntu.com</p>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <AnimationContainer animation="fadeUp" delay={0.5}>
                                <div className="mt-10 md:mt-0">
                                    <h3 className="text-base font-medium">Research</h3>
                                    <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <AnimationContainer animation="fadeUp" delay={1}>
                    <div className="mt-16 border-t border-border/40 py-8 flex flex-col md:flex-row items-center justify-center">
                        <p className="text-sm text-muted-foreground">
                            © {new Date().getFullYear()} Deepubuntu. All rights reserved.
                        </p>
                    </div>
                </AnimationContainer>
            </Wrapper>
