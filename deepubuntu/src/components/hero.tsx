...
import TeslaViewer from "./ev-vehicle";
            ...
            <div className="flex flex-col lg:flex-row w-full h-full lg:gap-16">
                <div className="flex flex-col items-start gap-10 py-8 w-full">
                    <div className="flex flex-col items-start gap-4">
                        <AnimationContainer animation="fadeUp" delay={0.2}>
                            <SectionBadge title="NEXT-GENERATION AV DATA" />
                        </AnimationContainer>
                        ...
                        <AnimationContainer animation="fadeUp" delay={0.6}>
                            <p className="text-sm md:text-base lg:text-lg text-muted-foreground">
                                Comprehensive datasets from unpaved roads, extreme weather, and complex traffic patterns across rural America, Africa and Asia.
                            </p>
                        </AnimationContainer>
                    </div>
                ...
                <AnimationContainer animation="fadeRight" delay={0.4}>
                    <div className="flex flex-col items-start justify-start w-full h-min relative overflow-visible">
                        <div className="lg:aspect-[1.388/1] w-full lg:w-[1000px] relative">
