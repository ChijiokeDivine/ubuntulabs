            ...
            <div className="flex flex-col items-center text-center gap-4 py-8 w-full">
                ...
                <AnimationContainer animation="fadeUp" delay={0.3}>
                    <h1 className="text-2xl md:text-4xl lg:text-5xl font-medium !leading-tight text-transparent bg-clip-text bg-gradient-to-b from-foreground to-neutral-400">
                        Comprehensive AV Data Platform
                    </h1>
                </AnimationContainer>

                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-lg mx-auto">
                       From sensor fusion to deployment, we deliver diverse & challenging autonomous vehicle datasets from real-world conditions.
                    </p>
                </AnimationContainer>
            </div>
                        ...
                        >
                            <div className="flex items-center gap-x-4">
                                <AnimationContainer
                                    ...
                                    delay={0.7 + (index * 0.2)}
                                >
                                    <div className="size-10 rounded-full bg-gradient-to-b from-primary to-grey-400 flex items-center justify-center">
