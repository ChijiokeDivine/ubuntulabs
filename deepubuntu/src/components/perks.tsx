            ...
            <div className="flex flex-col items-center text-center gap-4">
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
                       While others react to edge cases after they cause failures, we anticipate, simulate and address them before they hit your fleet.
                    </p>
                </AnimationContainer>
            </div>
                            ...
                            >
                                <div className="flex flex-col items-center text-center gap-4">
                                    <div className="size-12 lg:size-16 rounded-lg lg:rounded-2xl bg-neutral-900 flex items-center justify-center">
                                        <perk.icon className="size-8 lg:size-10 text-white" />
                                    </div>
